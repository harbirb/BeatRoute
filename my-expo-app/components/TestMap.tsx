...
export default function PolylineVisualizer() {
  const viewShotRef = useRef(null);

  // Correct polyline (Times Square → Central Park)
  ...
  // // Capture & Save the Polyline Image
  const captureAndSave = async () => {
    try {
      const uri = await viewShotRef.current.capture();
      const fileUri = `${FileSystem.documentDirectory}polyline.png`;
